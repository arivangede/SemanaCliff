...
export default function LocationSection() {
  return (
    <div
      id="location"
      className="flex flex-wrap items-center justify-center w-full px-16 py-8 md:justify-between"
    >
      <div className="flex flex-col items-center justify-center gap-2 text-white md:items-start">
        <h1 className="text-2xl md:text-6xl">Our Location</h1>
        <span>&quot;Discover Your Perfect Getaway – Visit Us Today!&quot;</span>
      </div>
      <iframe
